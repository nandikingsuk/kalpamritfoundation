            ...
            <div>
                    ...
                    <div className="card-img-overlay">
                        <div className="card text-center bg-transparent border-0">
                            <div className="card-body">
                                <h2 className="card-title text-white">OUR VALUES</h2>
                                <hr className="p-1 bg-warning w-25 mx-auto"/>
                                <p className="card-text text-white fs-5">Kalpamrit foundation trust offers its members ecological citizenship to solve the environment and render one’s duties towards mankind and only in this way to attain true happiness and mentally and spiritually find the satisfaction of life.</p>
                                <p className="card-text text-white fs-5">Everyone has a purpose in life a unique gift or a special talent to give to others and We help to blend this unique talent with service to others to experience the ecstasy and expectation of our own spirit which is the ultimate goal of all goals.</p>
                                <p className="card-text text-white fs-5">The purpose of this society coincides with the soul of Indian Constitution that enshrines “It shall be the duty of every citizen of India to protect and improve the natural environment including forests lakes rivers and wildlife and to have compassion for living creatures”</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="card bg-dark">
                    ...
                    <div className="card-img-overlay">
                        <div className="card text-center bg-transparent border-0">
                            <div className="card-body">
                                <h2 className="card-title text-white">“We will make this World a better livable place”</h2>
                                <hr className="p-1 bg-warning w-25 mx-auto fs-5"/>
                                <p className="card-text text-white fs-5">We are always committed to inculcating a sense of responsibility towards forest, animals, soil, air, water.</p>
                            </div>
                        </div>
                    </div>
                </div>
